...
- 💻 I am proficient in Java, Python, and JavaScript, and experienced in web development (HTML, CSS, React, Node.js), AI/ML frameworks (TensorFlow, PyTorch, Scikit-learn), and databases (MySQL, PostgreSQL, MongoDB).  
- 🎯 Former Product Manager: experience in recommender and push systems, now transitioning into engineering and AI-driven solutions.
- 😄 Pronouns: He/His
